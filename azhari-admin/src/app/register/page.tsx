  ...
  return (
    <main className="page-fade">
      ...
      <div className="max-w-xl mx-auto px-6 py-10">
        <h1 className="font-display text-2xl font-bold text-ink mb-1">التسجيل في المسابقة</h1>
        <p className="text-ink-faint text-sm mb-6">يرجى ملء جميع البيانات بدقة</p>
